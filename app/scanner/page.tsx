...
export default function ScannerPage() {
  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      setError(msg.includes('NEXT_PUBLIC_GEMINI_API_KEY') || msg.includes('GEMINI_API_KEY')
        ? 'Set GEMINI_API_KEY or NEXT_PUBLIC_GEMINI_API_KEY in your Vercel env vars to enable scanner AI.'
        : `Analysis failed: ${msg}`);
    } finally {
